...
export const EmployeeCard: FC<Props> = (props) => {
    ...
    return (
        <div className="w-auto p-4 bg-slate-100">
            <div className="w-[360px] h-[260px] h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col">
                ...
                <p className="text-gray-600 mb-2">サイクル開始日: {employee.employee_detail.cycle_start_date.toString()}から</p>
